...
const AdvertismentList = () => {
  ...
  let headers = [
    ...
    },
    {
      ...
      Cell: (row) => {
        console.log(row);
        return <img src={row.row.original.thumbnail} width={100} />;
      },
    },
    {
      Header: "created by",
  ...
  return (
    <div>
      <div className="flex justify-end">
        <button
          className="flex justify-center bg-primary text-white font-semibold hover:bg-hover-color  items-center rounded-md px-2 py-1 w-[90px] "
